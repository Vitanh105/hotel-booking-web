    ...
    <div className=" px-10 bg-gray-50 py-10 rounded-md">
      <div className=" containerr">
        <div className=" flex justify-between items-end pb-6">
          ...
          <button
            className=" px-4 py-2 bg-lime-600 flex items-center gap-3 rounded-md"
      ...
      {showError ? (
        <div className=" fixed top-24 right-6 w-80 text-center bg-neutral-50 shadow">
          ...
          <div className=" py-4 text-xs px-4 font-semibold text-red-400 ">
            {errors}
          </div>
        </div>
      ) : null}
